window.App = (() => {
 ...
 <div><p class="badge-pill mb-4"><i class="fa-solid fa-store"></i> Tentang CoffeeStore</p><h1 class="section-title text-4xl md:text-6xl text-slate-900 ">Coffee shop modern untuk pengalaman belanja cepat.</h1><p class="mt-5 text-slate-600 leading-8">CoffeeStore adalah frontend toko online simulasi yang menjual coffee, non coffee, dan food. Seluruh transaksi, wishlist, login, checkout, pembayaran, dan riwayat pesanan berjalan menggunakan Local Storage.</p><div class="mt-8 grid sm:grid-cols-3 gap-4"><div class="soft-card rounded-3xl p-5"><strong class="text-3xl">30+</strong><p class="text-sm text-slate-500">Produk</p></div><div class="soft-card rounded-3xl p-5"><strong class="text-3xl">24/7</strong><p class="text-sm text-slate-500">Simulasi</p></div><div class="soft-card rounded-3xl p-5"><strong class="text-3xl">100%</strong><p class="text-sm text-slate-500">Frontend</p></div></div></div>
 <img src="https://images.unsplash.com/photo-1521017432531-fbd92d768814?auto=format&fit=crop&w=1400&q=80" alt="Interior coffee shop" class="rounded-[2.5rem] h-[520px] w-full object-cover shadow-2xl">
 </div>
 </section>`;
 }
